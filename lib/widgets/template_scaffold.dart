        ...
        child:  Scaffold(drawer: onlyBackButton || hideAllActions ? null : Drawer(
          ...
          appBar: AppBar(
              ...
              title: Row(crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Flexible(child: TextButton(onPressed: onAppbarTitlePressed ?? (onlyBackButton || hideAllActions || onDefaultAppbarTitlePressed == null ? null : () => onDefaultAppbarTitlePressed!(context)), child: Text(appbarTitle ?? onGenerateDefaultAppbarTitle(context), style: Theme.of(context).textTheme.titleLarge!, overflow: TextOverflow.fade,))),//.copyWith(color: Theme.of(context).colorScheme.onPrimary))),),
